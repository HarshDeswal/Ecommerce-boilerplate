...
const Header = () => {
  ...
  const cartItem = useSelector(store => store.products.favouriteProducts);
  ...
  return (
    <div className='h-20 w-full px-8 py-2 bg-blue-500 text-white  flex flex-col items-center md:flex-row justify-around'>
        ...
        {user && <div className='flex justify-end md:justify-normal p-2 items-center'>
        ...
        <div class="flex justify-center items-center">
            <div class="relative">
                <div class="absolute left-3">
                    <p class="flex items-center justify-center rounded-full bg-red-500 ml-3 -mt-1 px-1 text-[12px] text-white">{cartItem.length}</p>
                </div>
